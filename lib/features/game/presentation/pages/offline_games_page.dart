...
class OfflineGamesPage extends ConsumerWidget {
  ...
  void _showCreateGameSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const CreateGameSheet(isOnlineMode: false),
    );
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final offlineGames = state.games.where((g) => !g.isOnline).toList();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Organize a local game and meet\nplayers in your area!',
