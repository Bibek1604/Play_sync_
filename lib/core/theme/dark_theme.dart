...
/// PlaySync Dark Theme
/// Premium dark mode with proper contrast and emerald→teal accents
class DarkTheme {
  DarkTheme._();
  ...
  static ThemeData get theme {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.dark(
        ...
        tertiaryContainer: AppColors.purple800,
        onTertiaryContainer: AppColors.purple100,
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          textStyle: AppTypography.button,
          side: const BorderSide(color: AppColors.borderDefaultDark, width: 1.5),
          minimumSize: const Size(88, AppSpacing.buttonHeightMedium),
        ),
      ),
      ...
      chipTheme: ChipThemeData(
        ...
        disabledColor: AppColors.backgroundTertiaryDark,
      ...
      sliderTheme: SliderThemeData(
        ...
        inactiveTrackColor: AppColors.emerald800,
